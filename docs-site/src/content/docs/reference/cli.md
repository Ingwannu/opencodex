...
installed with (`bun install -g @ingwannu/opencodex@latest` or `npm install -g @ingwannu/opencodex@latest`). It detects a
...
New versions become available the moment the [Release workflow](https://github.com/Ingwannu/opencodex/actions/workflows/release.yml)
